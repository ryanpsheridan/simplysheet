...
heroImage: "/images/featured budget thumbnail-net worth tracker-right-positioned-v2.png"
lightImage: "/images/featured budget thumbnail-net worth tracker-light-theme-right-positioned-v2.png"
midImage: "/images/featured budget thumbnail-net worth tracker-v2.png"
midImageLight: "/images/featured budget thumbnail-net worth tracker-light-theme-v2.png"
features:
...
howItWorks:
  ...
  - heading: "Setting up assets"
    body: >-
      Each row is one asset. Enter a name (e.g. Checking Account, Brokerage, Primary Home), the
      current value, a category (Cash & Savings, Investments, Retirement, Real Estate, Vehicles),
      and pick a color. The sheet auto-calculates what percentage each asset represents of your
  ...
  - heading: "Tracking over time"
    body: >-
      The <strong>History Log</strong> tab is where you record monthly snapshots. At the end of
      each month, log your total assets, total liabilities, and net worth. The Dashboard shows
      your current month-over-month change, and the History Log builds a long-term view of your
      trajectory.
...
Which means the tools that actually move this number are the everyday ones. A [budget spreadsheet](/spreadsheets/budget-spreadsheet/) is what creates the gap in the first place. The [debt payoff tracker](/spreadsheets/debt-payoff-tracker/) works the liabilities side, and clearing a balance improves net worth exactly as much as saving the same amount. The [savings goals tracker](/spreadsheets/savings-goals-tracker/) works the assets side with targets you can actually feel.
