...
This is usually where a simple [shared couples budget spreadsheet](/templates/couples-budget-spreadsheet/) earns its place over juggling separate apps or separate mental tallies. One shared sheet means both people are reacting to the same numbers, which removes a surprising amount of the friction before it has a chance to turn into an argument.
