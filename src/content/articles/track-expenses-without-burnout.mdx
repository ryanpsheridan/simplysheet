...
faq:
  ...
  - question: 'How many categories should I use to track expenses?'
    answer: "Somewhere between five and ten is enough for most people. Housing, transportation, food, shopping, entertainment, savings, and miscellaneous covers the bulk of a typical budget. You can always split a category later if it turns out to deserve more detail. Starting broad makes it far more likely you'll still be tracking a month from now."
...
![Bar chart comparing actual spending to expected spending by category in a budget spreadsheet](/images/inline-article-image-expenses-categories-graph.jpg)
