...
A [debt payoff tracker](/templates/debt-payoff-tracker/) tends to work well here for the same reason a spreadsheet works for budgeting in general. It's one place, updated by hand, that shows the real numbers without needing four logins to piece together the same picture.
