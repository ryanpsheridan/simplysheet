...
pubDate: 'Jun 25 2026'
image: '/images/article-how-to-pay-off-debt.svg'
cardImage: '/images/card-how-to-pay-off-debt.svg'
tags: ['debt-payoff']
schema:
...
A simple [shared sheet](https://simplysheetdesign.etsy.com?utm_source=simplysheetdesign_site&utm_medium=article&utm_campaign=how-to-pay-off-debt) tends to work well here for the same reason it works for budgeting in general. It's one place, updated by hand, that shows the real numbers without needing four logins to piece together the same picture.
...
<DebtCalculator slug="how-to-pay-off-debt" />
