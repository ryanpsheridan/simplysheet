...
<EmergencyFundCalculator slug="emergency-fund-sizing" />
...
Once you have a target and you're putting money toward it, the part that keeps it going is being able to see the progress over time. A [simple savings tracker](https://www.etsy.com/listing/4483664616/sinking-funds-tracker-google-sheets?utm_source=simplysheetdesign_site&utm_medium=article&utm_campaign=emergency-fund-sizing) can make that visible in a way that a bank balance alone usually doesn't.
