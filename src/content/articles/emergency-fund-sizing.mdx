...
description: "Your emergency fund number isn't one-size-fits-all, it depends on your expenses and income stability. Here's how to calculate the right amount for you."
pubDate: 'Jun 26 2026'
...
If you're not sure where the money for this should come from in your budget, the [50/30/20 rule](/articles/50-30-20-budget-rule/) puts savings and debt payoff in one shared 20% slice of take-home pay, which is a reasonable place to point at an emergency fund until it's built up.
