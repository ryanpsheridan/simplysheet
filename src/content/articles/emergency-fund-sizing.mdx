...
Once you have a target and you're putting money toward it, the part that keeps it going is being able to see the progress over time. A [savings goals tracker](/templates/savings-goals-tracker/) can make that visible in a way that a bank balance alone usually doesn't.
