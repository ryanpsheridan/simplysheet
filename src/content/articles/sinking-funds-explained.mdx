...
description: A sinking fund is money set aside gradually for expenses you know are coming, so they stop feeling like emergencies. Here's how to start one.
pubDate: 2026-06-30
tags:
  - savings-goals
  - expense-tracking
...
This is also why a spreadsheet tracker is helpful. You can set up categories for each sinking fund, plug in your target amounts and dates, and watch the balance grow as you add money each month. The math is simple, but automation keeps you from having to recalculate manually every month. [Track your sinking funds in the Sinking Funds Tracker](/spreadsheets/sinking-funds-tracker/), which pairs monthly contribution tracking with a progress view so you can see which funds are on pace and which need adjustment.
