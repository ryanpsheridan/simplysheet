...
This is also why a spreadsheet tracker is helpful. You can set up categories for each sinking fund, plug in your target amounts and dates, and watch the balance grow as you add money each month. The math is simple, but automation keeps you from having to recalculate manually every month. [Track your sinking funds in the Savings Goals Tracker](/spreadsheets/savings-goals-tracker/), which pairs monthly contribution tracking with a progress view so you can see which funds are on pace and which need adjustment.
