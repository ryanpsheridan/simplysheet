...
If those two incomes are far apart, one thing worth settling early is how you split the shared bills. [Splitting them in proportion to income](/articles/how-to-split-bills-with-different-incomes/) usually feels fairer than a straight 50/50 when one paycheck is much larger, since it leaves both people with a similar amount of their own money left over.
