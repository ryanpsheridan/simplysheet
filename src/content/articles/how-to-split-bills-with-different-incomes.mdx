...
description: "When one partner earns more, a 50/50 split can strain the lower earner. Here's how to split bills fairly by income, with a calculator to run your own numbers."
pubDate: 'Jul 20 2026'
...
| Take-home pay | Pays 50/50 | Left to live on |
|---|---|---|
...
Use the same kind of number for both of you. If one partner is paid biweekly and the other monthly, [convert each paycheck to monthly income](/articles/how-to-calculate-monthly-income/) before comparing, or the biweekly earner's share will look smaller than it really is.

| Take-home pay | Share of income | Pays by income |
|---|---|---|
| You: $4,500 | 64% | $1,929 |
| Partner: $2,500 | 36% | $1,071 |
...
Want to come back to this later? The [bill split calculator](/tools/bill-split-calculator/) has the same tool on its own page.
